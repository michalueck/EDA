...
![pbbottle.](/Users/michaelalueck/desktop/r/pbbottle.png)
...
volatile acidity: the amount of acetic acid, too high levels can lead to 
unpleasnt taste (vinegar like )
citric acid: can add 'freshness' to the wine
residual sugar: amount of sugar after fermentation stops
chlorides: amount of salt 
free sulfur dioxide: free from of SO2, prevents microbiological growth and 
oxidation total sulfur dioxied: amount of free and bound SO2, becomes evident 
in nose and taste
...
![analysis.](/Users/michaelalueck/desktop/r/analysis.png)
...
![type.](/Users/michaelalueck/desktop/r/type.gif)
...
![sorry.](/Users/michaelalueck/desktop/r/sorry.png)
...
```
I googled the relation between the ph- socre and citirc acid: H3Citrate	citiric 
...
The boxplot is devlivering less information than the scatterplot above, 
but it is more compact and they 
can be easily compared. Here we can see that good wines have a higher level 
...
```{r echo=FALSE, Plot_Three.3}
ggplot(rw, aes(x = pH, y = volatile.acidity, color = factor(rating))) +
  geom_jitter() +
  scale_color_brewer(name = "Rating") +
  ggtitle("Rating by pH and votile.acidity") +
  xlab("pH ") +
  ylab("votile.acidity")
```
...
![night.](/Users/michaelalueck/desktop/r/night.png)
